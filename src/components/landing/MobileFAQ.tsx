...
export function MobileFAQ() {
    return (
        <section className="lg:hidden py-16 px-4 bg-white text-[#040949]">
            <div className="container mx-auto">
                ...
                >
                    <h2 className="text-2xl font-extrabold mb-2 text-[#040949]">
                        Dúvidas{' '}
                ...
                <Accordion type="single" collapsible className="space-y-3">
                    {faqs.map((faq, index) => (
                        ...
                        >
                            <AccordionItem value={`item-${index}`} className="bg-gray-50 border border-gray-200 rounded-xl px-4">
                                <AccordionTrigger className="text-left hover:no-underline text-[#040949] font-bold text-sm py-3">
                                    {faq.question}
                                </AccordionTrigger>
