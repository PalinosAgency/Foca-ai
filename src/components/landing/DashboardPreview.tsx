...
export function DashboardPreview() {
  ...
  // --- COMPONENTE TELA (Reutilizável para não duplicar código) ---
  ...
  return (
    <section className="py-12 md:py-24 px-4 overflow-hidden bg-[#040949]">
      <div className="container mx-auto">
        ...
        {/* ==========================================================================
            1. LAYOUT MOBILE (< 1024px)
            Usa EXATAMENTE a lógica do código que você mandou:
            Largura 1200px fixa + Scale reduzido para caber na tela.
            ==========================================================================
        */}
        <div className="block lg:hidden w-full relative">
           {/* Container de Altura Fixa para reservar espaço (calculado aprox para o scale) */}
           <div className="h-[220px] xs:h-[260px] sm:h-[400px] md:h-[500px] w-full flex justify-center overflow-visible">
              
              <div className="
                  /* Fixa o tamanho desktop */
                  w-[1200px] h-[750px]
                  
                  /* Posicionamento */
                  absolute top-0 left-1/2 -translate-x-1/2 origin-top
                  
                  /* A ESCALA QUE VOCÊ PEDIU */
                  transform 
                  scale-[0.23]      
                  xs:scale-[0.28]   
                  sm:scale-[0.45]   
        ...
        {/* ==========================================================================
            ...
            Layout nativo, fluido, sem escalas. Ocupa 100% da largura do container.
            ==========================================================================
        */}
        <div className="hidden lg:block max-w-6xl mx-auto">
          ...
          {/* Brilho de Fundo (Apenas no desktop para não pesar no mobile) */}
