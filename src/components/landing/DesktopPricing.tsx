...
export function DesktopPricing() {
    ...
    return (
        <section className="hidden lg:block py-24 px-4 bg-[#040949] text-white">
            <div className="container mx-auto">
                ...
                <div className="flex justify-center max-w-5xl mx-auto">
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="relative w-full max-w-sm bg-white text-[#040949] rounded-2xl p-8 shadow-2xl ring-4 ring-[#0026f7]/20 hover:scale-105 transition-transform duration-300"
                    >
