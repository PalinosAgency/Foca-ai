    ...
    onSuccess: async (tokenResponse) => {
      ...
      try {
        const response = await fetch('/api/admin', {
          ...
          body: JSON.stringify({ action: 'login-google', accessToken: tokenResponse.access_token }),
        });
    ...
    >
      ...
      <div className="space-y-4">
        <p className="text-center text-sm text-gray-600 mb-4">
          O acesso a este painel é restrito. Você precisa estar autenticado com um e-mail do Google autorizado pela administração.
        </p>
        <Button
          variant="outline"
          type="button"
        ...
        >
          ...
          {isLoading ? 'Verificando...' : 'Entrar com Google (Acesso Restrito)'}
        </Button>
      </div>
    </AuthLayout>
  );
