      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
             {/* ... Inputs de Email/Senha mantidos iguais ... */}
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-xs text-[#0026f7] font-semibold hover:underline">Esqueceu a senha?</Link>
              </div>
              <div className="relative">
                <Input
                  id="password"
            ...
            <Button type="submit" className="w-full h-12 font-bold text-base shadow-md bg-[#0026f7] text-white" disabled={isLoading}>
              {isLoading ? <><Loader2 className="w-5 h-5 mr-2 animate-spin" /> Entrando...</> : 'Entrar na plataforma'}
            </Button>

            <div className="text-center pt-2 border-t border-gray-100">
              <p className="text-sm text-gray-600">
                Ainda não tem uma conta? <Link to="/register" state={location.state} className="text-[#0026f7] font-bold hover:underline">Criar conta grátis</Link>
              </p>
            </div>
          </form>
        </AuthLayout>
